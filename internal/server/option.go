...
// Swagger returns an Option to set the Swagger
func Swagger(swagger *SwaggerOpts) Option {
	return func(s *Service) {
		s.swagger = swagger
	}
}
...
// GRPCServiceRegister returns an Option to append a gRPC dial option
func GRPCServiceRegister(fn GRPCServiceRegisterFunc) Option {
	return func(s *Service) {
		s.grpcServiceRegister = fn
	}
}

// ReverseProxyRegister returns an Option to append a gRPC dial option
func ReverseProxyRegister(fn ReverseProxyRegisterFunc) Option {
	return func(s *Service) {
		s.reverseProxyRegister = fn
	}
}
