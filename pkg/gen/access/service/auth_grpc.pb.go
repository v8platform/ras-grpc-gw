...
func (c *authServiceClient) SingIn(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Tokens, error) {
	out := new(Tokens)
	err := c.cc.Invoke(ctx, "/access.service.AuthService/SingIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_SingIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/access.service.AuthService/SingIn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SingIn(ctx, req.(*GetRequest))
	}
...
func _AuthService_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/access.service.AuthService/Refresh",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "access.service.AuthService",
	...
	Metadata: "access/service/auth.proto",
}
